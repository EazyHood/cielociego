...
*[Léelo en español](README.es.md) · [Full report](https://eazyhood.github.io/cielociego/) · [The write-up](https://eazyhood.github.io/cielociego/post.html)*
...
**The measurements themselves belong to nobody.** Anyone can reproduce them and
publish their own figures — that is precisely why the code is MIT. What is
reserved is the writing and the composition, not the fact that it is true.

Copernicus data is openly available under ESA's terms.
