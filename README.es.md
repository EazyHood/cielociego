...
*[Read this in English](README.md) · [Informe completo](https://eazyhood.github.io/cielociego/) · [The write-up](https://eazyhood.github.io/cielociego/post.html)*
...
**Las mediciones no son de nadie.** Cualquiera puede reproducirlas y publicar sus
propias cifras: para eso está el código en MIT. Lo que se reserva es la redacción
y la composición, no el hecho de que sea cierto.

Los datos Copernicus son de acceso libre bajo los términos de la ESA.
